...
public class LocaleFilter extends BaseFilter{
    ...
    /**
     * Loads {@link Interpreter} object from specified bundle
     */
    private void loadInterpreter() {
        Interpreter translator = new Interpreter(Constants.ROUTES.BUNDLE_PATH, locales);
        servContext.setAttribute(Constants.Attributes.TRANSLATOR, translator);
        LOGGER.debug("Interpreter loaded.");
    }
